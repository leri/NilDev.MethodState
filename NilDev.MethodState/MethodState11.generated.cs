...
namespace NilDev.MethodState
{
    ...
    public struct MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
    {
        ...
        public void Observe(Action<T1> observer1, Action<T2> observer2, Action<T3> observer3, Action<T4> observer4, Action<T5> observer5, Action<T6> observer6, Action<T7> observer7, Action<T8> observer8, Action<T9> observer9, Action<T10> observer10, Action<T11> observer11, Action nullObserver)
        {
        ...
        /// </summary>
        /// <param name="state">Current state.</param>
        public static implicit operator MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T1 state)
        {
            if (state is null)
            {
                return new MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>();
            }

            return new MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(state);
        }
        ...
        /// </summary>
        /// <param name="state">Current state.</param>
        public static implicit operator MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T2 state)
        {
            if (state is null)
            {
                return new MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>();
        ...
        /// </summary>
        /// <param name="state">Current state.</param>
        public static implicit operator MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T3 state)
        {
            if (state is null)
            {
                return new MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>();
        ...
        /// </summary>
        /// <param name="state">Current state.</param>
        public static implicit operator MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T4 state)
        {
            if (state is null)
            {
                return new MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>();
        ...
        /// </summary>
        /// <param name="state">Current state.</param>
        public static implicit operator MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T5 state)
        {
            if (state is null)
            {
                return new MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>();
        ...
        /// </summary>
        /// <param name="state">Current state.</param>
        public static implicit operator MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T6 state)
        {
            if (state is null)
            {
                return new MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>();
        ...
        /// </summary>
        /// <param name="state">Current state.</param>
        public static implicit operator MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T7 state)
        {
            if (state is null)
            {
                return new MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>();
        ...
        /// </summary>
        /// <param name="state">Current state.</param>
        public static implicit operator MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T8 state)
        {
            if (state is null)
            {
                return new MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>();
        ...
        /// </summary>
        /// <param name="state">Current state.</param>
        public static implicit operator MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T9 state)
        {
            if (state is null)
            {
                return new MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>();
        ...
        /// </summary>
        /// <param name="state">Current state.</param>
        public static implicit operator MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T10 state)
        {
            if (state is null)
            {
                return new MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>();
        ...
        /// </summary>
        /// <param name="state">Current state.</param>
        public static implicit operator MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T11 state)
        {
            if (state is null)
            {
                return new MethodState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>();
