...
namespace NilDev.MethodState
{
    ...
    public struct MethodState<T1, T2, T3, T4>
    {
        ...
        public void Observe(Action<T1> observer1, Action<T2> observer2, Action<T3> observer3, Action<T4> observer4, Action nullObserver)
        {
        ...
        public Task ObserveAsync(Func<T1, Task> observer1, Func<T2, Task> observer2, Func<T3, Task> observer3, Func<T4, Task> observer4, Func<Task> nullObserver)
        {
            return Observe(observer1, observer2, observer3, observer4, nullObserver);
        }
        ...
        public TResult Observe<TResult>(Func<T1, TResult> observer1, Func<T2, TResult> observer2, Func<T3, TResult> observer3, Func<T4, TResult> observer4, Func<TResult> nullObserver)
        {
            switch (_selectedTypeIndex)
            {
                case 1:
        ...
        /// <param name="nullObserver">Asynchronous observer when the current state is null</param>
        /// <returns>Task</returns>
        public Task<TResult> ObserveAsync<TResult>(Func<T1, Task<TResult>> observer1, Func<T2, Task<TResult>> observer2, Func<T3, Task<TResult>> observer3, Func<T4, Task<TResult>> observer4, Func<Task<TResult>> nullObserver)
        {
            return Observe(observer1, observer2, observer3, observer4, nullObserver);
        }
        ...
        /// </summary>
        /// <param name="state">Current state.</param>
        public static implicit operator MethodState<T1, T2, T3, T4>(T1 state)
        {
            if (state is null)
            {
                return new MethodState<T1, T2, T3, T4>();
            }

            return new MethodState<T1, T2, T3, T4>(state);
        }
        ...
        /// </summary>
        /// <param name="state">Current state.</param>
        public static implicit operator MethodState<T1, T2, T3, T4>(T2 state)
        {
            if (state is null)
            {
                return new MethodState<T1, T2, T3, T4>();
        ...
        /// </summary>
        /// <param name="state">Current state.</param>
        public static implicit operator MethodState<T1, T2, T3, T4>(T3 state)
        {
            if (state is null)
            {
                return new MethodState<T1, T2, T3, T4>();
        ...
        /// </summary>
        /// <param name="state">Current state.</param>
        public static implicit operator MethodState<T1, T2, T3, T4>(T4 state)
        {
            if (state is null)
            {
                return new MethodState<T1, T2, T3, T4>();
